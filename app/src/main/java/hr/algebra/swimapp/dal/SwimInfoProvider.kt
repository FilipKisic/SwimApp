package hr.algebra.swimapp.dal

import android.content.*
import android.database.Cursor
import android.net.Uri
import hr.algebra.swimapp.factory.getRepository
import hr.algebra.swimapp.model.SwimInfo
import java.lang.IllegalArgumentException

private const val AUTHORITY = "hr.algebra.swimapp.dal.provider"
private const val PATH = "swimInfo"
val SWIM_INFO_PROVIDER_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/$PATH")
...
class SwimInfoProvider : ContentProvider() {
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        return ContentUris.withAppendedId(SWIM_INFO_PROVIDER_CONTENT_URI, id)
    }
